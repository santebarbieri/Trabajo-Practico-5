...
<html>
    ...
    <body>
        ...
        <div id="edit-practica" class="content scaffold-edit" role="main">
            ...
            <g:hasErrors bean="${this.practica}">
            <ul class="errors" role="alert">
                <g:eachError bean="${this.practica}" var="error">
                <li <g:if test="${error in org.springframework.validation.FieldError}">data-field-id="${error.field}"</g:if>><g:message error="${error}"/></li>
                </g:eachError>
            </ul>
            </g:hasErrors>
            <g:form resource="${this.practica}" method="PUT">
                <g:hiddenField name="version" value="${this.practica?.version}" />
                <fieldset class="form">
                    <f:all bean="practica"/>
                </fieldset>

...
<html>
    ...
    <body>
        ...
        <div id="show-practica" class="content scaffold-show" role="main">
            ...
            <f:display bean="practica" />
            <g:form resource="${this.practica}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.practica}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
